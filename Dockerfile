...
zlib1g-dev liblog4cpp5-dev libncurses5-dev libselinux1-dev wget libsqlite3-dev google-mock libvirt-dev \
libmysqlclient20=5.7.11-0ubuntu6 libmysqlclient-dev=5.7.11-0ubuntu6 \
