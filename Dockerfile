...
RUN apt-get update && apt-get install -y apt-transport-https curl bison++ libssl-dev libprocps4-dev libxalan-c-dev libxerces-c-dev libnl-3-dev libtinyxml2-dev \
